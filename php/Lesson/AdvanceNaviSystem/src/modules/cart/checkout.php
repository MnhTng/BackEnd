        ...
        <div class="checkout-detail hidden-right">
            <form action="" method="POST">
                ...
                <fieldset>
                    ...
                    <input class="input" type="text" name="fullname" value="" autocomplete="off" spellcheck="false">
                </fieldset>

                <fieldset>
                    <legend>Email</legend>
                    <input class="input" type="email" name="email" value="" autocomplete="off" spellcheck="false">
                </fieldset>

                <fieldset>
                    <legend>Phone number</legend>
                    <input class="input" type="tel" name="tel" value="" autocomplete="off" spellcheck="false">
                </fieldset>
                    ...
                    if (isset($code)) {
                        ...
                        foreach ($listProduct as $product) {
                            if ($product['code'] == $code) {
                                ...
                                echo "<div class='info'>";
                                echo "<div class='name'>";
                                echo "<span>" . mb_convert_case($product['name'], MB_CASE_TITLE) . "</span>";
                                echo "<span>Size: " . strtoupper((string)$size) . "</span>";
                                echo "</div>";
                                echo "<div class='price'>";
                                echo "<div>";
                                if (!empty($product['sale'])) {
                                    echo "<span class='price-new'>" . number_format($product['sale'], 0, '', ',')  . "₫</span>";
                                    echo "<span class='price-old'>" . number_format($product['price'], 0, '', ',') . "₫</span>";

                                    $total = (int)$product['sale'] * $quantity;
                                    $discount = ((int)$product['price'] - (int)$product['sale']) * $quantity;
                                } else {
                        ...
                        foreach ($_SESSION['cart']['add'] as $item) {
                            foreach ($item as $itemBySize) {
                                echo "<div class='item'>";
                                echo "<img src='{$itemBySize['image']}' alt='product'>";
                                echo "<div class='info'>";
                                echo "<div class='name'>";
                                echo "<span>" . mb_convert_case($itemBySize['name'], MB_CASE_TITLE) . "</span>";
                                ...
                                echo "</div>";
                                echo "<span>x" . $itemBySize['quantity'] . "</span>";
                                echo "</div>";
                                echo "</div>";
                                echo "</div>";
                            }
                            ...
                            <div class="cart-total">
                                <div class="detail">
                                    <div>
                                        ...
                                        <span>
                                            <?php echo !empty($product['sale']) ? number_format($product['sale'], 0, '', ',') . "₫" : number_format($product['price'], 0, '', ',') . "₫"; ?>
                                        </span>
                                    </div>
                    ...
                    <div class="cart-total">
                        <div class="detail">
                            <div>
                                <span>Total value of products</span>
                                <span>
                                    <?php echo number_format($_SESSION['cart']['info']['total'], 0, '', ',') . "₫"; ?>
                                </span>
                            </div>
