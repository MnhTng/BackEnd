<?php require "./src/controllers/log/signupHandle.php"; ?>
...
<body>
    <form action="" method="post" class="hidden-right">
        ...
        <p id="exist_user">Existing user, sign in <a class="form" href="?mod=log&act=login">Here</a></p>

        <input type="hidden" id="hidden" name="redirect_to" value="?mod=log&act=login">
