...
<head>
    ...
    <script src="./src/lib/js/jquery-3.7.1.min.js"></script>
    <title>DMT</title>
</head>
...
<body>
    <div class="container">
        <header>
            ...
            <a href="?mod=log&act=login" class="login-btn underline-top-bot" id="login-btn"></a>
        </header>
        ...
        <nav id="main-nav">
            ...
            <ul>
                ...
                <li><a class="underline_center" href="?mod=posts&act=main">Products</a></li>
                <li><a class="underline_center" href="?mod=pages&act=about">About Us</a></li>
                <li><a class="underline_center" href="?mod=pages&act=contact">Contact</a></li>
            </ul>
            ...
            <div class="tools">
                ...
                <div class="cart">
                    <a class="number-item" href="?mod=cart&act=main">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6" width="2em" height="2em">
                        ...
                        if (isset($_SESSION['is_login'], $_SESSION['cart']) && !empty($cartByID)) {
                            ob_start();
