        ...
        <div class="hidden-rotate acc-inner">
            <div class="acc-front">
                ...
                <div class="acc-content">
                    ...
                    <div class="gender">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor" width="2em" height="2em">
                    ...
                    <div class="birthday">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" width="2em" height="2em">
                    ...
                    <div class="email">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" width="2em" height="2em">
...
<script>
    ...
    let emptyGender = <?php ob_start();
                        if (empty($_SESSION['account']['gender'])) echo 0;
                        else echo 1;
                        ob_end_flush(); ?>;
    let emptyBirthday = <?php ob_start();
