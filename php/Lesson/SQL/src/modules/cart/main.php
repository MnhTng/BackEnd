...
<main>
    <div class="cart-container">
        <?php if (isset($_SESSION['is_login'], $_SESSION['cart']) && !empty($cartByID)) { ?>
            ...
            <div class="cart-content hidden-left">
                ...
                <div class="cart-list">
                    ...
                    foreach ($cartByID as $item) {
                        ...
                        echo "<a href='?mod=posts&act=detail&id={$item['productID']}&cat={$cat}&code={$item['pcode']}' class='cart-item-img'>";
                        echo "<img src='{$item['image']}' alt=''>";
                        echo "</a>";

                        echo "<div class='cart-item-info'>";
                        echo "<div class='info'>";
                        echo "<a href='?mod=posts&act=detail&id={$item['productID']}&cat={$cat}&code={$item['pcode']}'>" . mb_convert_case($item['name'], MB_CASE_TITLE) . "</a>";
