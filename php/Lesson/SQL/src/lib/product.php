...
function show_result_search($search, $page)
{
    ...
    if (!empty($filter)) {
        ...
        if ($page > 1) {
            ...
            echo "
                <span class='prev'>
                    <a href='?mod=pages&act=search&page={$prePage}'>
                        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='1em' height='1em'>
                            <path d='M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z' />
                        </svg>
                    </a>
        ...
        if ($page - 1 > 2)
            echo "
                <span class='page'><a href='?mod=pages&act=search&page=1'>1</a></span>
            ...
            echo "<span class='page'><a href='?mod=pages&act=search&page=1'>1</a></span>";

        for ($i = max($page - 1, 1); $i <= min($page + 1, $totalPage); $i++) {
            if ($i == $page)
                echo "<span class='page'><a class='current-page' href='?mod=pages&act=search&page={$i}'>{$i}</a></span>";
            else
                echo "<span class='page'><a href='?mod=pages&act=search&page={$i}'>{$i}</a></span>";
        }
        ...
        if ($totalPage - $page > 2)
            echo "
                ...
                <span class='page'><a href='?mod=pages&act=search&page={$totalPage}'>{$totalPage}</a></span>
                ";
        else if ($totalPage - $page == 2)
            echo "<span class='page'><a href='?mod=pages&act=search&page={$totalPage}'>{$totalPage}</a></span>";

        if ($page < $totalPage) {
            $nextPage = $page + 1;
            echo "
                <span class='next'>
                    <a href='?mod=pages&act=search&page={$nextPage}'>
                        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='1em' height='1em'>
                            <path d='M470.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 256 265.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160zm-352 160l160-160c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L210.7 256 73.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0z' />
                        </svg>
                    </a>
